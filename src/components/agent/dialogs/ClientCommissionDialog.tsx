...
const ClientCommissionDialog: React.FC<ClientCommissionDialogProps> = ({
  open,
  onClose,
  onSubmit,
  isSubmitting,
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {initialData
              ? t("editClientCommission")
              : t("addClientCommission")}
          </DialogTitle>
          <DialogDescription>
            {initialData
              ? t("editClientCommissionDescription")
              : t("addClientCommissionDescription")}
          </DialogDescription>
        </DialogHeader>
