...
interface CommissionUploadDialogProps {
  open: boolean;
  onClose: () => void;
}

const CommissionUploadDialog: React.FC<CommissionUploadDialogProps> = ({
  open,
  onClose,
}) => {
  const { t } = useLanguage();
      ...
      if (progress >= 100) {
        ...
        setTimeout(() => {
          ...
          toast({
            ...
            description: t("commissionCalculationCompleted"),
          });
        }, 500);
      }
    }, 300);
        ...
        return (
          <>
            <div className="space-y-4 py-4 text-center">
              ...
              <h3 className="font-medium text-lg">{t("calculationSuccessful")}</h3>
              <p className="text-muted-foreground">
                {t("calculationSuccessDescription")}
              </p>
            </div>
            <DialogFooter>
...
export default CommissionUploadDialog;
