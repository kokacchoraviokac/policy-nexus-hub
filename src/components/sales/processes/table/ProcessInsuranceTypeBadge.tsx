...
interface ProcessInsuranceTypeBadgeProps {
  type: string;
}

const ProcessInsuranceTypeBadge: React.FC<ProcessInsuranceTypeBadgeProps> = ({ type }) => {
  const { t } = useLanguage();
...
export default ProcessInsuranceTypeBadge;
